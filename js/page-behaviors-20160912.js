...
$(".attorney-icon").click(function(){
	...
	practiceAreaIconRow.sort();	
	//console.log(practiceAreaIconRow);
	$('#attorney-' + attyName + ' .row .desc-exc .atty-practices').html(practiceAreaIconRow);
...
$('#vid-1').attr('src','//player.vimeo.com/video/84156653?title=0&byline=0&portrait=0');
$('#vid-2').attr('src','//player.vimeo.com/video/84156649?title=0&byline=0&portrait=0');	
